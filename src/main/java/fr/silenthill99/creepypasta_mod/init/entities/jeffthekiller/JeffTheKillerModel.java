package fr.silenthill99.creepypasta_mod.init.entities.jeffthekiller;// Made with Blockbench 4.2.3
...
public class JeffTheKillerModel<T extends JeffTheKiller> extends EntityModel<T> {
